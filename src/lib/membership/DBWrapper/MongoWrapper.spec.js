...
describe('Mongo Wrapper', function () {
  ...
  describe('find user by id fail', function () {
    ...
    it('should throw an assertion error if id is not present', async function (done) {
      try {
        await mongoWrapper.findUserById();
      } catch (err) {
        done();
      }
  ...
  describe.only('find user by id success', function () {
    ...
    it('find user by id success', async function (done) {
      const user = await mongoWrapper.findUserById("56955ca46063c5600627f393");
